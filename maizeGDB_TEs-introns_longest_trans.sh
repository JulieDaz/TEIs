...
# python3 ~/maize/pipeline_SVs-introns/calculate_nb_exons_lengths.py -gff Zm-$1-REFERENCE-NAM-*_Zm*.1.gff3

# ## get intron from longest transcript
# Rscript ~/maize/pipeline_SVs-introns/get_introns_longest_trans.R Zmays-$1_genes-introns.bed Zm-$1-REFERENCE-NAM-1.0_*.gff3.exoncat Zmays-$1_genes-introns_longest_trans.bed

# ## intersect between the SVinGene ovl and the introns
# bedtools intersect -a Zmays-$1_MaizeGDB_allTEs_genes--intersect_ovl.bed -b Zmays-$1_genes-introns_longest_trans.bed -wo > Zmays-$1_MaizeGDB_allTEs_introns_longest_trans--intersect.txt

# # ## calculate perc of ovl, selection based on threshold
# python3 ~/maize/pipeline_SVs-introns/calculate_coverage_ovl.py -i Zmays-$1_MaizeGDB_allTEs_introns_longest_trans--intersect.txt

# select unique ovl if several ovl in the same intron
python3 ~/maize/pipeline_SVs-introns/select_unique_ovl_TEfam.py -i  Zmays-$1_MaizeGDB_allTEs_introns_longest_trans--intersect_ovl_coverage.txt
# python3 ~/Documents/Chapter3/Scripts/pipeline_SVs-introns/select_unique_ovl_TEfam.py -i  Zmays-$1_MaizeGDB_allTEs_introns--intersect_ovl_coverage.txt

# ### Adds category of overlaps between introns and TE in the selected file
python3 ~/maize/pipeline_SVs-introns/add_cov_cat_selected_intron-TE_ovl.py -i Zmays-$1_MaizeGDB_allTEs_introns_longest_trans--intersect_ovl_coverage_selected.txt
# python3 ~/Documents/Chapter3/Scripts/pipeline_SVs-introns/add_cov_cat_selected_intron-TE_ovl.py -i Zmays-$1_MaizeGDB_allTEs_introns--intersect_ovl_coverage_selected.txt
