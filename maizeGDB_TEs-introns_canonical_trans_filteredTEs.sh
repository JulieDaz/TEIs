...
# filter the TEs
Rscript ~/maize/pipeline_SVs-introns/filtering_TEs.R Zmays-$1_MaizeGDB_allTEs $2 $3

# intersect between TEs and genes
bedtools intersect -a Zmays-$1_MaizeGDB_allTEs_filtered$2-$3.bed -b Zmays-$1_genes.bed -wao > Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_genes--intersect.txt

nb_TEs=$(wc Zmays-$1_MaizeGDB_allTEs_filtered$2-$3.bed | awk '{print $1}')
...
python3 ~/maize/pipeline_SVs-introns/calculate_ovl.py -i Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_genes--intersect.txt -type TE -transposon $nb_TEs -gene $nb_genes
...
bedtools intersect -a Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_genes--intersect_ovl.bed -b Zmays-$1_genes-introns_canonical_trans.bed -wo > Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_introns_canonical_trans--intersect.txt

## calculate perc of ovl, selection based on threshold
python3 ~/maize/pipeline_SVs-introns/calculate_coverage_ovl.py -i Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_introns_canonical_trans--intersect.txt

# select unique ovl if several ovl in the same intron
python3 ~/maize/pipeline_SVs-introns/select_unique_ovl_TEfam.py -i  Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_introns_canonical_trans--intersect_ovl_coverage.txt

# ### Adds category of overlaps between introns and TE in the selected file
python3 ~/maize/pipeline_SVs-introns/add_cov_cat_selected_intron-TE_ovl.py -i Zmays-$1_MaizeGDB_allTEs_filtered$2-$3_introns_canonical_trans--intersect_ovl_coverage_selected.txt
