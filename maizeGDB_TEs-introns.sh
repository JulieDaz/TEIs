...
bedtools intersect -a Zmays-$1_MaizeGDB_allTEs_genes--intersect_ovl.bed -b Zmays-$1_genes-introns.bed -wo > Zmays-$1_MaizeGDB_allTEs_introns--intersect.txt

# ## calculate perc of ovl, selection based on threshold
python3 ~/maize/pipeline_SVs-introns/calculate_coverage_ovl.py -i Zmays-$1_MaizeGDB_allTEs_introns--intersect.txt

# select unique ovl if several ovl in the same intron
python3 ~/maize/pipeline_SVs-introns/select_unique_ovl_TEfam.py -i  Zmays-$1_MaizeGDB_allTEs_introns--intersect_ovl_coverage.txt

# ### Adds category of overlaps between introns and TE in the selected file
python3 ~/maize/pipeline_SVs-introns/add_cov_cat_selected_intron-TE_ovl.py -i Zmays-$1_MaizeGDB_allTEs_introns--intersect_ovl_coverage_selected.txt
